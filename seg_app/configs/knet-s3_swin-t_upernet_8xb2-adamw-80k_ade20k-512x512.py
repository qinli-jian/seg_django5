...
data_root = 'data/multi_defect_new/'
...
train_cfg = dict(
    max_iters=120000, type='IterBasedTrainLoop', val_interval=10000)
...
work_dir = 'work_dirs\\Q\\knet-s3_swin-t_upernet_8xb2-adamw-80k_ade20k-512x512.py'
